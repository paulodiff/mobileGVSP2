...
module.exports = function (grunt) {
  ...
  require('grunt-imagemagick')(grunt);
  ...
  grunt.initConfig({
    ...
    "imagemagick-hisrc":{
      ...
      dev:{
        args:['splash/resizeme.jpg','-resize', '25x25', 'splash/resized/resizeme-small.jpg'],
        fatals: true
      }
    },
    ...
    ngconstant: {
      ...
      development: {
        constants: {
          ENV: {
            name: 'development',
            token: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VybmFtZSI6IldXRi1JVEFMSUEiLCJpc0F1dGhvcml6ZWQiOnRydWV9.VWHKW_O31P4Eg2PwW3PvAufKSI3dfDPF8XY3_Ce05sQ',
            apiEndpoint: 'http://10.0.1.157:3000',
            userName: 'PROVINCIA',
            isAuthorized : true
          }
        }
      ...
      production: {
        constants: {
          ENV: {
            name: 'production',
            token: '',
            apiEndpoint: 'http://federadati.provincia.rimini.it:3000',
            userName: '',
            isAuthorized : false
          }
        }
  ...
  grunt.registerTask('splash', [ 'imagemagick-resize' ]);    
